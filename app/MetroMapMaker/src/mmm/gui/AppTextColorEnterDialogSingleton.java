 ...
 */
public class AppTextColorEnterDialogSingleton extends Stage {
    // HERE'S THE SINGLETON OBJECT
    static AppTextColorEnterDialogSingleton singleton = null;
     ...
     */
    private AppTextColorEnterDialogSingleton() {}
     ...
     */
    public static AppTextColorEnterDialogSingleton getSingleton() {
	if (singleton == null)
	    singleton = new AppTextColorEnterDialogSingleton();
	return singleton;
    }
    ...
    public void init(Stage owner) {
        ...
        enterButton.setOnAction(e->{ 
            ...
            selection = true;
            AppTextColorEnterDialogSingleton.this.close();
        });
